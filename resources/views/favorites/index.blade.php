            ...
            @endif
                <div class="p-6">
                    ...
                    @else
                        ...
                        @elseif($isDesigner)
                            <a href="{{ route('designer.concepts.index') }}" class="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 to-indigo-500 text-white px-6 py-3 rounded-xl font-semibold hover:from-purple-600 hover:to-indigo-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
                        @elseif($isConstructor)
