    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('designer.concepts.edit', $concept) }}" class="flex items-center gap-2 bg-gradient-to-r from-teal-500 to-cyan-500 text-white px-6 py-3 rounded-xl font-bold hover:from-teal-600 hover:to-cyan-600 transition-all duration-300 shadow-lg hover:shadow-xl">
                        ...
                        <div class="p-6">
                            <div class="flex items-start gap-6 mb-6">
                                ...
                                <div class="flex-1">
                                    ...
                                    @endif
                                    @if($concept->category)
                                        <span class="inline-block px-4 py-2 bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-700 rounded-full text-sm font-semibold">{{ $concept->category->name }}</span>
                                    @endif
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-semibold text-gray-900">
                                        <span class="px-3 py-1 bg-gradient-to-r from-purple-100 to-indigo-100 text-purple-700 rounded-full text-xs font-semibold">Designer</span>
                                    </p>
                                </div>
                                <div>
