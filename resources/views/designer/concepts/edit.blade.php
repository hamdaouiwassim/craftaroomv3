                                ...
                                <div class="bg-white/60 rounded-xl p-5 border border-teal-100">
                                    ...
                                    @if($concept->threedmodels)
                                        <div class="flex items-center justify-between py-2 border-t border-gray-100">
                                            ...
                                            <form action="{{ route('designer.concepts.delete-model', $concept) }}" method="POST" onsubmit="return confirm('Supprimer le modèle 3D ?');">
                                                @csrf
                                                @method('DELETE')
                                    ...
                                    @if($concept->reel)
                                        <div class="flex items-center justify-between py-2 border-t border-gray-100">
                                            ...
                                            <form action="{{ route('designer.concepts.delete-reel', $concept) }}" method="POST" onsubmit="return confirm('Supprimer le reel ?');">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="text-sm text-red-600 hover:text-red-700 font-medium">Supprimer</button>
                                            </form>
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-4 mt-10 pt-6 border-t-2 border-purple-200">
                            ...
                            <div class="flex items-center gap-3 order-last">
                                ...
                                <button type="button" x-show="currentStep < totalSteps"
                                        x-on:click="nextStep()"
                                        class="px-8 py-3 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-xl font-bold hover:from-purple-600 hover:to-indigo-600">
                                    Suivant
                                </button>
                                <button type="submit" x-show="currentStep === totalSteps"
                                        class="px-8 py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-xl font-bold hover:from-green-600 hover:to-emerald-600">
                                    Enregistrer
                                </button>
                            </div>
                        </div>
