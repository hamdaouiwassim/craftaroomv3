<x-designer-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('designer.concepts.show', $concept) }}" class="px-6 py-3 bg-gray-200 text-gray-700 rounded-xl font-semibold hover:bg-gray-300 transition-all">
                Voir le concept
            </a>
        </div>
    </x-slot>
                ...
                <form action="{{ route('designer.concepts.save-customize', $concept) }}" method="POST" class="space-y-8">
                    ...
                    @if($concept->metals->count() > 0)
                        <div class="flex justify-end gap-4 pt-6 border-t border-teal-100">
                            <a href="{{ route('designer.concepts.show', $concept) }}" class="px-6 py-3 bg-gray-200 text-gray-700 rounded-xl font-semibold hover:bg-gray-300">
                                Annuler
                            </a>
