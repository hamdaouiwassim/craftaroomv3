...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Craftaroom') }} - Designer</title>
    ...
    <body class="font-sans antialiased bg-gradient-to-br from-gray-50 via-purple-50/30 to-indigo-50/30">
        <div class="min-h-screen flex">
            @include('designer.layouts.navigation')
        ...
        <div id="global-app-loader" class="hidden fixed inset-0 z-[100] bg-slate-950/55 backdrop-blur-sm">
            <div class="flex min-h-screen items-center justify-center p-6">
                <div class="w-full max-w-sm rounded-3xl bg-white shadow-2xl border border-purple-100 p-8 text-center">
                    <div class="mx-auto mb-5 h-16 w-16 rounded-full bg-gradient-to-br from-purple-500 to-indigo-500 flex items-center justify-center shadow-lg">
