                                ...
                                <div class="grid grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <input type="number" step="0.01" name="length" id="length"
                                            value="{{ old('length', optional($dim)->length ?? '') }}"
                                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                                        @error('length')
                                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01" name="width" id="width"
                                            value="{{ old('width', optional($dim)->width ?? '') }}"
                                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                                        @error('width')
                                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <input type="number" step="0.01" name="height" id="height"
                                            value="{{ old('height', optional($dim)->height ?? '') }}"
                                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                                        @error('height')
                                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <select name="unit" id="unit"
                                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                                            @php $dimUnit = old('unit', optional($dim)->unit ?? ''); @endphp
                                            <option value="">Sélectionner une unité</option>
                                            <option value="CM" {{ $dimUnit === 'CM' ? 'selected' : '' }}>CM (Centimètres)</option>
                                            <option value="FT" {{ $dimUnit === 'FT' ? 'selected' : '' }}>FT (Pieds)</option>
                                            <option value="INCH" {{ $dimUnit === 'INCH' ? 'selected' : '' }}>INCH (Pouces)</option>
                                        </select>
                                        @error('unit')
                                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="number" step="0.01" name="weight_value" id="weight_value"
                                            value="{{ old('weight_value', optional($weight)->weight_value ?? '') }}"
                                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                                        @error('weight_value')
                                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <select name="weight_unit" id="weight_unit"
                                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                                            @php $weightUnit = old('weight_unit', optional($weight)->weight_unit ?? ''); @endphp
                                            <option value="">Sélectionner une unité</option>
                                            <option value="KG" {{ $weightUnit === 'KG' ? 'selected' : '' }}>KG (Kilogrammes)</option>
                                            <option value="LB" {{ $weightUnit === 'LB' ? 'selected' : '' }}>LB (Livres)</option>
                                        </select>
                                        @error('weight_unit')
                                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                        @enderror
