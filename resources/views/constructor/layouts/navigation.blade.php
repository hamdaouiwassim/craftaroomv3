    ...
    <aside 
        ...
        <nav class="flex-1 overflow-y-auto p-4 space-y-1">
            <a href="{{ route('landing') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-lg font-semibold transition-all duration-300 text-gray-700 hover:bg-orange-50">
            ...
            <a href="{{ route('constructor.offers.index') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-lg font-semibold transition-all duration-300 {{ request()->routeIs('constructor.offers.*') ? 'bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-lg' : 'text-gray-700 hover:bg-orange-50' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
