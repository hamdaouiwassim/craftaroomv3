    ...
    <body class="font-sans antialiased bg-gradient-to-br from-gray-50 via-green-50/30 to-emerald-50/30">
        ...
        <div id="global-app-loader" class="hidden fixed inset-0 z-[100] bg-slate-950/55 backdrop-blur-sm">
            <div class="flex min-h-screen items-center justify-center p-6">
                <div class="w-full max-w-sm rounded-3xl bg-white shadow-2xl border border-emerald-100 p-8 text-center">
                    <div class="mx-auto mb-5 h-16 w-16 rounded-full bg-gradient-to-br from-emerald-500 to-teal-500 flex items-center justify-center shadow-lg">
