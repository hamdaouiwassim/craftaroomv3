    ...
    <div class="flex items-center justify-center min-h-screen px-4">
        ...
        <div class="relative bg-white rounded-2xl shadow-xl max-w-4xl w-full p-8 max-h-[90vh] overflow-y-auto">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        @foreach($concept->photos as $photo)
                            <div class="relative group">
                                ...
                                <form action="{{ route('admin.library-concepts.delete-photo', [$concept, $photo]) }}" method="POST" class="absolute top-2 right-2">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" 
            ...
            <div>
                ...
                <form action="{{ route('admin.library-concepts.upload-photos', $concept) }}" method="POST" enctype="multipart/form-data">
                    @csrf
