        ...
        <div class="relative bg-white rounded-2xl shadow-xl max-w-2xl w-full p-8">
            ...
            @if($concept->reel)
                <div class="mb-6">
                    ...
                    <form action="{{ route('admin.library-concepts.delete-reel', $concept) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" 
            ...
            <div>
                ...
                <form action="{{ route('admin.library-concepts.upload-reel', $concept) }}" method="POST" enctype="multipart/form-data">
                    @csrf
