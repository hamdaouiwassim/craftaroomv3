    ...
    <aside 
        ...
        <nav class="flex-1 min-h-0 overflow-y-auto p-4 space-y-1">
            <a href="{{ route('landing') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-lg font-semibold transition-all duration-300 text-gray-700 hover:bg-teal-50">
            ...
            <a href="{{ route('admin.construction-requests.index') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-lg font-semibold transition-all duration-300 {{ request()->routeIs('admin.construction-requests.*') || request()->routeIs('admin.offers.*') ? 'bg-gradient-to-r from-teal-500 to-cyan-500 text-white shadow-lg' : 'text-gray-700 hover:bg-teal-50' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
