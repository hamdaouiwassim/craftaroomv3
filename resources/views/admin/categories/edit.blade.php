<x-admin-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Modifier catégorie <span>{{ $category->name }}</span> :
...
<div class="mb-4">
                ...
                <select  name="status" id="status" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                    <option @if ($category->status === 'active') selected @endif value="active">Actif</option>
                    <option @if ($category->status === 'inactive') selected @endif value="inactive">Non actif</option>
            ...
            @enderror
                ...
                <div class="mb-4">
                    ...
                    <select onchange="toggleParentCategory()" name="type" id="type"
                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                        <option @if ($category->type === 'main') selected @endif value="main">Principale</option>
                        <option @if ($category->type === 'sub') selected @endif value="sub">Secondaire</option>
                ...
                <div class="mb-4">
                    <label for="description" class="block text-sm font-medium text-gray-700">Description de la catégorie
                        :</label>
                ...
                @if ($category->icon)
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Icon actuelle :</label>
                ...
                <div class="flex justify-end">
                    <button type="submit" class="px-4 py-2 bg-green-500 text-white rounded-md">Mettre a jour</button>
