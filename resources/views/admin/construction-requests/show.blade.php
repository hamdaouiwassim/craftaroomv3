    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.construction-requests.index') }}" class="p-2 bg-orange-100 hover:bg-orange-200 rounded-lg transition-colors">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl border-2 border-orange-100 overflow-hidden shadow-lg">
                        ...
                        <div class="p-6">
                            ...
                            <form action="{{ route('admin.construction-requests.submit-offer', $request->id) }}" method="POST">
                                @csrf
                                <div class="space-y-4">
                                    <div>
